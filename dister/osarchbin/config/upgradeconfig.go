...
import (
	...
	"github.com/sniperkit/snk.fork.palantir-distgo/dister/osarchbin/config/internal/legacy"
	"github.com/sniperkit/snk.fork.palantir-distgo/dister/osarchbin/config/internal/v0"
)
