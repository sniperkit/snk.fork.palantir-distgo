...
import (
	...
	"github.com/sniperkit/snk.fork.palantir-distgo/dister/manual/config/internal/legacy"
	"github.com/sniperkit/snk.fork.palantir-distgo/dister/manual/config/internal/v0"
)
